...
# Pine Script Agent Kit — portable knowledge

This is a generated snapshot. Source URLs and complete metadata live in
`knowledge/sources.json` and `knowledge/catalog.json`.
