...
- [ ] Yeni veya değişen kural [kural katkı şablonunu](../docs/rule-contribution-template.md) izliyor / A new or changed rule follows the [rule contribution template](../docs/rule-contribution-template.md)
